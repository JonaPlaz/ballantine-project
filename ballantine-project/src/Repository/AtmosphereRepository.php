...
/**
 * @extends ServiceEntityRepository<Atmosphere>
 *
...
class AtmosphereRepository extends ServiceEntityRepository
{
    ...
    public function save(Atmosphere $entity, bool $flush = false): void
    {
    ...
    public function remove(Atmosphere $entity, bool $flush = false): void
    {
